...
## From nozzle file that comes with data downloaded from firebrowse2:
### From nozzle file that comes with data downloaded from firebrowse3:
...
Function that creates matrix of the proportion of co-deletion and co-amplification events per gene.

Function can: interogate all genes, specific genes, specific chromosomal regions, specific chromosomes, specific chromsome and chromosomal regions and specific cytobands.
...
list.CNV.all.table.co.del<-lapply(c(seq(1:22), "X"), function(x) co.deletion_co.amplification_matrix(CNV.all.table.chr.location, column_start = 11, threshold = -1,Chromosome = x, 
                                                                                                     deletion = TRUE))
...
list.CNV.all.table.co.amp<-lapply(c(seq(1:22), "X"), function(x) co.deletion_co.amplification_matrix
                                  (CNV.all.table.chr.location, column_start = 11, threshold = 1,
                                    Chromosome = x, deletion = FALSE))
...
Find more target genes e.g. suppl matrerial of paper?
