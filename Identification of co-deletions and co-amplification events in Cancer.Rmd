...
```{r co-deletions_heatmap, eval=FALSE}
...
```{r cytobands_deletion_heatmap2, eval=FALSE}
...
Function to calculate the number of deletions or duplications per cytoband or 


```{r cytobands_deletion_heatmap, eval=FALSE}
...
```{r amplifications_cytobands, eval=FALSE}
...
```{r deletion_chromosome_interval, eval=FALSE}
################
